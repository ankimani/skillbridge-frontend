...
import { fetchAllTeachers } from '../../components/services/allTeachersProfile';
...
const TeachersTab = () => {
  ...
  useEffect(() => {
    const fetchTeachers = async () => {
      try {
        setLoading(true);
        const result = await fetchAllTeachers(currentPage, teachersPerPage, searchTerm);
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
                  {selectedTeacher.imagePath ? (
                    <img 
                      ...
                      alt={`Profile image of ${selectedTeacher.displayName}`}
