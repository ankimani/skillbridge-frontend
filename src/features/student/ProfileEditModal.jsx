...
const ProfileEditModal = ({ profile, onClose, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" role="dialog" aria-modal="true" aria-labelledby="edit-profile-modal-title">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        {/* Modal Header */}
        <div className="sticky top-0 bg-white z-10 flex justify-between items-center border-b border-gray-200 p-6">
          <h2 id="edit-profile-modal-title" className="text-2xl font-bold text-gray-800">Edit Personal Information</h2>
          <button
            onClick={onClose}
